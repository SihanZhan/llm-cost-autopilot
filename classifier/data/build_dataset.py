...
TIER1_PROMPTS = [
    ...
    "My hotel is 5 miles from the airport — how many kilometers is that? Output only the number, rounded to one decimal.",
    ...
    "My suitcase is 3 kilograms over the airline's weight limit — how many pounds is that? Output only the number, rounded to one decimal.",
    ...
    "Give me one word that means the opposite of \"ascend\".",
    ...
    "What's the plural form of \"child\"? Just the word, nothing else.",
